...
cdef class CUgraphDeviceNode:
    ...
    """
    cdef ccuda.CUgraphDeviceNode  __val
    cdef ccuda.CUgraphDeviceNode* _ptr
...
cdef class CUasyncCallbackHandle:
    ...
    """
    cdef ccuda.CUasyncCallbackHandle  __val
    cdef ccuda.CUasyncCallbackHandle* _ptr
...
cdef class CUgreenCtx:
    ...
    """
    cdef ccuda.CUgreenCtx  __val
    cdef ccuda.CUgreenCtx* _ptr
...
cdef class CUdevResourceDesc:
    ...
    """
    cdef ccuda.CUdevResourceDesc  __val
    cdef ccuda.CUdevResourceDesc* _ptr
...
cdef class CUasyncCallback:
    ...
    """
    cdef ccuda.CUasyncCallback  __val
    cdef ccuda.CUasyncCallback* _ptr
...
cdef class anon_struct0:
    ...
    """
    cdef ccuda.CUasyncNotificationInfo_st* _ptr
...
cdef class CUasyncNotificationInfo_st:
    ...
    """
    cdef ccuda.CUasyncNotificationInfo_st* _val_ptr
    cdef ccuda.CUasyncNotificationInfo_st* _ptr
...
cdef class CUexecAffinityParam_st:
    ...
    """
    cdef ccuda.CUexecAffinityParam_st* _val_ptr
    cdef ccuda.CUexecAffinityParam_st* _ptr
...
cdef class CUctxCigParam_st:
    ...
    """
    cdef ccuda.CUctxCigParam_st __val
    cdef ccuda.CUctxCigParam_st* _ptr
...
cdef class CUctxCreateParams_st:
    ...
    """
    cdef ccuda.CUctxCreateParams_st __val
    cdef ccuda.CUctxCreateParams_st* _ptr
    cdef size_t _execAffinityParams_length
    cdef ccuda.CUexecAffinityParam* _execAffinityParams

    cdef size_t _cigParams_length
    cdef ccuda.CUctxCigParam* _cigParams
...
cdef class CUDA_RESOURCE_DESC_st:
    ...
    """
    cdef ccuda.CUDA_RESOURCE_DESC_st* _val_ptr
    cdef ccuda.CUDA_RESOURCE_DESC_st* _ptr
...
cdef class CUDA_EXTERNAL_MEMORY_HANDLE_DESC_st:
    ...
    """
    cdef ccuda.CUDA_EXTERNAL_MEMORY_HANDLE_DESC_st* _val_ptr
    cdef ccuda.CUDA_EXTERNAL_MEMORY_HANDLE_DESC_st* _ptr
...
cdef class CUDA_EXTERNAL_SEMAPHORE_HANDLE_DESC_st:
    ...
    """
    cdef ccuda.CUDA_EXTERNAL_SEMAPHORE_HANDLE_DESC_st* _val_ptr
    cdef ccuda.CUDA_EXTERNAL_SEMAPHORE_HANDLE_DESC_st* _ptr
...
cdef class CUarrayMapInfo_st:
    ...
    """
    cdef ccuda.CUarrayMapInfo_st* _val_ptr
    cdef ccuda.CUarrayMapInfo_st* _ptr
...
cdef class CUgraphNodeParams_st:
    ...
    """
    cdef ccuda.CUgraphNodeParams_st* _val_ptr
...
cdef class CUdevSmResource_st:
    ...
    """
    cdef ccuda.CUdevSmResource_st __val
    cdef ccuda.CUdevSmResource_st* _ptr
...
cdef class CUdevResource_st:
    ...
    """
    cdef ccuda.CUdevResource_st* _val_ptr
    cdef ccuda.CUdevResource_st* _ptr
...
cdef class CUeglFrame_st:
    ...
    """
    cdef ccuda.CUeglFrame_st* _val_ptr
    cdef ccuda.CUeglFrame_st* _ptr
